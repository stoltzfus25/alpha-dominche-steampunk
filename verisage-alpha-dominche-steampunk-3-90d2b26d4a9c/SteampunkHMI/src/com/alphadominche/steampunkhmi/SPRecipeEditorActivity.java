...
//		}
	...
	@Override
	public void update(Observable arg0, Object arg1) { SPLog.debug("updating from recipe edit!");
		if (mIgnoreUpdates)
			return;
	...
	public void displayWarningMessage() {
		EditRecipeWarningDialog dialog = new EditRecipeWarningDialog();
		dialog.show(getFragmentManager(), EditRecipeWarningDialog.TAG);
	}
