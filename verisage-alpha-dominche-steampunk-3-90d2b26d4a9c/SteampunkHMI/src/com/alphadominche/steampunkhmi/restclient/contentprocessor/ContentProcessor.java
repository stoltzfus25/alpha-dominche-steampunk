...
public interface ContentProcessor {
	 ...
	 * 
	 * @param recipeMap
	 *            a map with members "recipe", "stacks", and "agitations" which
	 *            describes a recipe
	 */
	 ...
	 *            id of the request
	 * @param machineId
	 *            id of the machine that this log is referring to
	 * @param userId
	 *            the id of the logged in user when this log was created, if any
	 * @param date
	 *            the date and time the log was generated
	 * @param recipeId
	 *            recipe that was running when log message was generated, if any
	 * @param crucibleIndex
	 *            crucible the log applies to, if any
	 * @param severity
	 *            severity of the log
	 * @param type
	 *            type of log
	 ...
	 *            the machine settings object to persist
	 */
	 ...
	 *            the account settings object to persist
	 */
	 ...
	 *            id of the request
	 * @param versionId
	 *            django id of the current version
	 * @param deviceId
	 *            django id of the device
	 */
	 ...
	 *            id of the request
	 * @param newVersion
	 *            django id of the version to download
	 */
