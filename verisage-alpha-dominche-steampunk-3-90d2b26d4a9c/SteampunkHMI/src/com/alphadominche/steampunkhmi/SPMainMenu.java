...
public class SPMainMenu extends Fragment {
	...
	private LinearLayout mAccountSettingsBtn;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mAccountSettingsBtn = (LinearLayout) rootView.findViewById(R.id.main_menu_account_settings_button);
		...
		OnClickListener clickListener = new OnClickListener() {
			...
			public void onClick(View v) {
				...
				switch (v.getId()) {
					case R.id.main_menu_account_settings_button:
				        intent.setClass(getActivity(), SPAccountSettingsActivity.class);
						break;
		...
		mAccountSettingsBtn.setOnClickListener(clickListener);
