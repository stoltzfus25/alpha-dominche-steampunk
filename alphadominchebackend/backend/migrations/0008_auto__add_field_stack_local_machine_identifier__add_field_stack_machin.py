...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stack.local_machine_identifier'
        db.add_column(u'backend_stack', 'local_machine_identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stack.machine_mac_address'
        db.add_column(u'backend_stack', 'machine_mac_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=17, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Recipe.local_identifier'
        db.delete_column(u'backend_recipe', 'local_identifier')

        # Adding field 'Recipe.local_machine_identifier'
        db.add_column(u'backend_recipe', 'local_machine_identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AgitationCycle.local_machine_identifier'
        db.add_column(u'backend_agitationcycle', 'local_machine_identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AgitationCycle.machine_mac_address'
        db.add_column(u'backend_agitationcycle', 'machine_mac_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=17, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stack.local_machine_identifier'
        db.delete_column(u'backend_stack', 'local_machine_identifier')

        # Deleting field 'Stack.machine_mac_address'
        db.delete_column(u'backend_stack', 'machine_mac_address')

        # Adding field 'Recipe.local_identifier'
        db.add_column(u'backend_recipe', 'local_identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Recipe.local_machine_identifier'
        db.delete_column(u'backend_recipe', 'local_machine_identifier')

        # Deleting field 'AgitationCycle.local_machine_identifier'
        db.delete_column(u'backend_agitationcycle', 'local_machine_identifier')

        # Deleting field 'AgitationCycle.machine_mac_address'
        db.delete_column(u'backend_agitationcycle', 'machine_mac_address')
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'duration': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_machine_identifier': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'null': 'True', 'blank': 'True'}),
            'machine_mac_address': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '17', 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
        ...
        u'backend.machine': {
            ...
            'PIN': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '4'}),
