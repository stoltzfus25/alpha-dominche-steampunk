...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Recipe.stacks'
        db.alter_column(u'backend_recipe', 'stacks', self.gf('django.db.models.fields.TextField')(null=True))

        for recipe in Recipe.objects.all():
            if recipe.version is None or recipe.version < 2:
                recipe.version = 2
                recipe.save()

        for favorite in Favorite.objects.all():
            if favorite.version is None or favorite.version < 2:
                favorite.version = 2
                favorite.save()
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Recipe.stacks'
        db.alter_column(u'backend_recipe', 'stacks', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
            'Meta': {'object_name': 'Favorite'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['backend.Recipe']", 'blank': 'True'}),
            'recipe_uuid': ('django.db.models.fields.CharField', [], {'default': "'e8090ef2c14e4062a2e6ebd1b7bb9270'", 'max_length': '50', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4bba93412bda49299467e2614c4dd28e'", 'max_length': '50', 'blank': 'True'}),
        ...
        u'backend.recipe': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'20ac5c487cb94b7aa9e20147716ca461'", 'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'version': ('django.db.models.fields.IntegerField', [], {'default': '2', 'blank': 'True'})
        },
        u'backend.roaster': {
