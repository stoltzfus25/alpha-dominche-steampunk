...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stack.local_machine_identifier'
        db.alter_column(u'backend_stack', 'local_machine_identifier', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Recipe.local_machine_identifier'
        db.alter_column(u'backend_recipe', 'local_machine_identifier', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'AgitationCycle.local_machine_identifier'
        db.alter_column(u'backend_agitationcycle', 'local_machine_identifier', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Stack.local_machine_identifier'
        db.alter_column(u'backend_stack', 'local_machine_identifier', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Recipe.local_machine_identifier'
        db.alter_column(u'backend_recipe', 'local_machine_identifier', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AgitationCycle.local_machine_identifier'
        db.alter_column(u'backend_agitationcycle', 'local_machine_identifier', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 18, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
