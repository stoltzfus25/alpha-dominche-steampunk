...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.message'
        db.alter_column(u'backend_log', 'message', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Machine.PIN'
        db.alter_column(u'backend_machine', 'PIN', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Log.message'
        db.alter_column(u'backend_log', 'message', self.gf('django.db.models.fields.TextField')(max_length=200, null=True))
