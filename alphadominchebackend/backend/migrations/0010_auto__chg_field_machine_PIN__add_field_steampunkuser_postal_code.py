...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Machine.PIN'
        db.alter_column(u'backend_machine', 'PIN', self.gf('django.db.models.fields.CharField')(max_length=4))
        # Adding field 'SteamPunkUser.postal_code'
        db.add_column(u'backend_steampunkuser', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False),
        # added a deleted column to recipe
        db.add_column(u'backend_recipe', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False))
        
    def backwards(self, orm):

        # Changing field 'Machine.PIN'
        db.alter_column(u'backend_machine', 'PIN', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=4))
        # Deleting field 'SteamPunkUser.postal_code'
        db.delete_column(u'backend_steampunkuser', 'postal_code')
        # Deleting field 'Recipe.deleted'
        db.delete_column(u'backend_recipe','deleted')
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
