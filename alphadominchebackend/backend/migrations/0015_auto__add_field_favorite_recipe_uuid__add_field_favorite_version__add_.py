...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Favorite.recipe_uuid'
#        db.add_column(u'backend_favorite', 'recipe_uuid',
#                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='r_uuid', to_field='uuid', to=orm['backend.Recipe']),
#                      keep_default=False)

        # Adding field 'Favorite.version'
        db.add_column(u'backend_favorite', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Recipe.version'
        db.add_column(u'backend_recipe', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding unique constraint on 'Recipe' and 'Favorite', fields ['uuid']
        db.create_unique(u'backend_recipe', ['uuid'])
        db.create_unique(u'backend_favorite', ['uuid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Recipe', fields ['uuid']
        db.delete_unique(u'backend_recipe', ['uuid'])
        db.delete_unique(u'backend_favorite', ['uuid'])

        # Deleting field 'Favorite.recipe_uuid'
#        db.delete_column(u'backend_favorite', 'recipe_uuid_id')

        # Deleting field 'Favorite.version'
        db.delete_column(u'backend_favorite', 'version')

        # Deleting field 'Recipe.version'
        db.delete_column(u'backend_recipe', 'version')
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
            'Meta': {'object_name': 'Favorite'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['backend.Recipe']"}),
#            'recipe_uuid': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'r_uuid'", 'to_field': "'uuid'", 'to': u"orm['backend.Recipe']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2473fd66fae040e6a51cd26b4f58bd42'", 'max_length': '50'}),
        ...
        u'backend.recipe': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d4bf7ecb9c9d428abcfd7edc6b0d62c6'", 'unique': 'True', 'max_length': '50', 'blank': 'True'}),
            'version': ('django.db.models.fields.IntegerField', [], {'default': '2'})
        },
        u'backend.roaster': {
