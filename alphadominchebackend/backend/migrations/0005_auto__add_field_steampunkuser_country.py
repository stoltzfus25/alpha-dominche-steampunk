...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SteamPunkUser.country'
        db.add_column(u'backend_steampunkuser', 'country',
                      self.gf('django.db.models.fields.CharField')(default='United States of America', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SteamPunkUser.country'
        db.delete_column(u'backend_steampunkuser', 'country')
