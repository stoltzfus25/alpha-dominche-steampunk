...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recipe.deleted'
        #db.add_column(u'backend_recipe', 'deleted',
        #              self.gf('django.db.models.fields.BooleanField')(default=False),
        #              keep_default=False)
        from django.contrib.auth.models import User

        # Making sure names get updated in the subscription groups
        users=User.objects.all()
        for user in users:
            username=user.username
            if user.steampunkuser!=None and user.steampunkuser.subscriptionGroup!=None:
                group=user.steampunkuser.subscriptionGroup
                group.roaster_name=username
                group.save()
    ...
    models = {
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
