...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Log.machine'
        db.alter_column(u'backend_log', 'machine_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Machine'], null=True))

    def backwards(self, orm):

        # Changing field 'Log.machine'
        db.alter_column(u'backend_log', 'machine_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['backend.Machine']))
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
