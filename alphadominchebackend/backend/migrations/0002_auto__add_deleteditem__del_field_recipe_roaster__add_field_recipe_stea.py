...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeletedItem'
        db.create_table(u'backend_deleteditem', (
            ...
            ('time_deleted', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 11, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'backend', ['DeletedItem'])

        db.rename_column(u'backend_recipe', 'roaster_id', 'steampunkuser_id')


    def backwards(self, orm):
        # Deleting model 'DeletedItem'
        db.delete_table(u'backend_deleteditem')

        db.rename_column(u'backend_recipe', 'steampunkuser_id', 'roaster_id')
    ...
    models = {
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
