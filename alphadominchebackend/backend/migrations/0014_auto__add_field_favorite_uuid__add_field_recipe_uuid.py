...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Favorite.uuid'
        db.add_column(u'backend_favorite', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='1e9d88fbf1b24927bd81b1ffb010f801', max_length=50),
                      keep_default=False)

        # Adding field 'Recipe.uuid'
        db.add_column(u'backend_recipe', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='aa3569ace2ae46fdbca25c68cf3334af', max_length=50, blank=True),
                      keep_default=False)

        if not db.dry_run:
            for recipe in orm.Recipe.objects.all():
                print "before: ", recipe.uuid
                recipe.uuid = uuid.uuid4().hex
                print "recipe: ", recipe.uuid
                recipe.save()

            for favorite in orm.Favorite.objects.all():
                print "before: ", favorite.uuid
                favorite.uuid = uuid.uuid4().hex
                print "fav: ", favorite.uuid
                favorite.save()


    def backwards(self, orm):
        # Deleting field 'Favorite.uuid'
        db.delete_column(u'backend_favorite', 'uuid')

        # Deleting field 'Recipe.uuid'
        db.delete_column(u'backend_recipe', 'uuid')
    ...
    models = {
        ...
        u'backend.agitationcycle': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'backend.deleteditem': {
            ...
            'time_deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'})
        },
        u'backend.favorite': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6199b12e480e4c06910132e98a45ebd0'", 'max_length': '50'})
        },
        u'backend.filter': {
        ...
        u'backend.recipe': {
            ...
            'type': ('django.db.models.fields.IntegerField', [], {}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'78010bfb8d444dabbd6fe2344f77a025'", 'max_length': '50', 'blank': 'True'})
        },
        u'backend.roaster': {
