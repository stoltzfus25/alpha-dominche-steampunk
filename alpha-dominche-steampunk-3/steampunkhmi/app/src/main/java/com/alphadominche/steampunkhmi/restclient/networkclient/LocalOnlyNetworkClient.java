...
public class LocalOnlyNetworkClient implements NetworkClient {

    private static final String TAG = LocalOnlyNetworkClient.class
            .getCanonicalName();
...
//			+ AGITATION_PATH_ID + "}";
    ...
    public LocalOnlyNetworkClient(Context context,
