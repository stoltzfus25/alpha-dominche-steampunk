...
public interface PersistenceServiceHelper {
     ...
     * @param published whether the recipe has been published
     * @param grams     grams of tea or coffee
     * @param teaspoons teaspoons of tea
     * @param grind     the amount the coffee has been ground
     * @param filter    the type of filter to be used
     */
     ...
     * Create a new log
     *
     * @param recipeId      recipe that was running when log message was generated, null
     *                      if no recipe is running
     * @param crucibleIndex crucible the log applies to, null if it doesn't apply to a
     *                      specific crucible
     * @param severity      severity of the log
     * @param type          type of log
     * @param message       message of the log, null if no message
     */
     ...
     *
     * @param recipdeId the recipe to add to the favorites list
     */
     ...
     *
     * @param recipeId the recipe to delete from the favorites list
     */
     ...
     * @param boilerTemp     the temperature of the boiler
     * @param rinseTemp      the temperature of the rinse cycle
     * @param rinseVoulme    volume of the rise cycle
     * @param elevation      elevation of where the machine is
     * @param crucibleStates a list of which crucibles are enabled and which are disabled
     * @param tempUnitType   unit type of the temperatures
     * @param volumeUnitType unit type of the volume
     */
     ...
     * @param protectRecipes whether or not recipes that are created are public or not
     */
